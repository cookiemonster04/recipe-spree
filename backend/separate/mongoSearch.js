...
// const testUndesired = ["onion", "beef", "pork", "peanut", "broccoli"];
...
const searchHandler = catchWrap(async (req, res, next) => {
  const { desired, undesired } = req.body;
  res.status(200).json(await search(desired, undesired));
});
